...
window = tk.Tk()
window.title("Crime Predicative Model/Tool for Hotspot Mapping")
...
message1 = tk.Label(window, text="Crime Predicative Model/Tool for Hotspot Mapping" ,bg=bgcolor  ,fg=fgcolor  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
clearButton = tk.Button(window, text="Clear", command=clear  ,fg=fgcolor  ,bg=bgcolor  ,width=20  ,height=2 ,activebackground = "White" ,font=('times', 15, ' bold '))
clearButton.place(x=960, y=200)

browse = tk.Button(window, text="Browse", command=browse  ,fg=fgcolor  ,bg=bgcolor  ,width=15  ,height=1, activebackground = "White" ,font=('times', 15, ' bold '))
browse.place(x=530, y=205)

pre = tk.Button(window, text="Preprocess", command=preprocess  ,fg=fgcolor  ,bg=bgcolor  ,width=18  ,height=2, activebackground = "White" ,font=('times', 15, ' bold '))
pre.place(x=10, y=600)

texta = tk.Button(window, text="Decision Tree", command=decisiontree  ,fg=fgcolor ,bg=bgcolor  ,width=18  ,height=2, activebackground = "White" ,font=('times', 15, ' bold '))
texta.place(x=200, y=600)

texta1 = tk.Button(window, text="RandomForest", command=randomforest  ,fg=fgcolor ,bg=bgcolor  ,width=18  ,height=2, activebackground = "White" ,font=('times', 15, ' bold '))
texta1.place(x=400, y=600)


pred = tk.Button(window, text="ARIMA", command=arima  ,fg=fgcolor,bg=bgcolor  ,width=18  ,height=2, activebackground = "White" ,font=('times', 15, ' bold '))
pred.place(x=600, y=600)

lst = tk.Button(window, text="LSTM", command=lstm  ,fg=fgcolor,bg=bgcolor  ,width=18  ,height=2, activebackground = "White" ,font=('times', 15, ' bold '))
lst.place(x=800, y=600)


quitWindow = tk.Button(window, text="QUIT", command=window.destroy  ,fg=fgcolor ,bg=bgcolor  ,width=18  ,height=2, activebackground = "White" ,font=('times', 15, ' bold '))
